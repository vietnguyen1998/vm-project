...
export default function About() {
  var [arr, setArr] = React.useState(["XL", "XXL", "XXXL"]);
  function closeModal() {
    const modal = document.querySelector("div.modal-add-user");
  ...
  function removeItem(index) {
    const shadowArr = arr;
    shadowArr.slice(index, 1);
    setArr([...shadowArr]);
  }
  function addNewSize(value) {
    setArr([arr, "1"]);
  ...
  return (
    <div>
      <div className="flex justify-between my-4">
        <p className="text-2xl font-medium text-gray-700">Product</p>
        <button
          onClick={openModal}
      ...
      <div className="hidden z-30 modal-add-user h-screen w-full fixed left-0 top-0 flex justify-center items-center bg-black bg-opacity-50">
        <div className="bg-white rounded shadow-lg w-10/12 md:w-1/3">
          ...
          <div className="my-4 p-4">
            <div className="flex justify-between mb-2">
              ...
              <div className="flex">
                <input className="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500 rounded-r-none border-r-0" />
            ...
            <div className="border p-2 bg-white">
              {arr.map((e, index) => (
                <div
                  key={index}
                  className="inline-block border px-2 py-1 relative rounded mr-2 bg-gray-100 mb-2"
                >
                  <p>{e}</p>
                  <button
